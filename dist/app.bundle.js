...
/******/ 	var hotCurrentHash = "f979de782eb571ceefc7"; // eslint-disable-line no-unused-vars
...
var _proxyList = __webpack_require__(39);

var _proxyList2 = _interopRequireDefault(_proxyList);

__webpack_require__(37);

var _insertData = __webpack_require__(40);

var _insertData2 = _interopRequireDefault(_insertData);

var _uniq = __webpack_require__(41);

var _uniq2 = _interopRequireDefault(_uniq);

var _verifyProxy = __webpack_require__(42);
  ...
  return _regenerator2.default.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _proxyList2.default)(arrProxy);

        case 2:
          arrProxy = _context.sent;
          _context.next = 5;
          return (0, _insertData2.default)('proxy-list', arrProxy);

        case 5:
          _context.next = 7;
          return (0, _uniq2.default)('proxy-list');
...
var mongoose = __webpack_require__(81);
...
var cheerio = __webpack_require__(80);
var request = __webpack_require__(34);
var proxyIp = __webpack_require__(38);
...
//按顺序发送request请求
var repeation = function () {
    var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(urls) {
        var _this = this;

        var len, times, _loop, i;
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        times = 1;
                        _loop = _regenerator2.default.mark(function _loop(_i) {
                            return _regenerator2.default.wrap(function _loop$(_context) {
                                while (1) {
                                    switch (_context.prev = _context.next) {
                                        case 0:
                                            _context.next = 2;
                                            return check(urls[_i]).then(function (simpleProxy) {
                                                console.log(urls[_i] + " bingo");
                                                checkedArr.push(simpleProxy);
                                            }, function (e) {
                                                //重新验证
                                                if (e == 'fuck') {
                                                    if (times < 2) {
                                                        console.log(urls[_i] + ' request error happened  and request at ' + ++times + ' times');
                                                        _i--;
                                                    } else {
                                                        times = 1;
                                                        console.log(urls[_i] + ' request error');
                                                    }
                                                } else {
                                                    console.log(e);
                                                }
